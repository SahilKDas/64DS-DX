...
{
    return character == WALUIGI_CHARACTER_WALUIGI
        ? WALUIGI_CHARACTER_WARIO
        : character;
}
...
void Player::SetRealCharacter(unsigned int chr_)
{
    ...
    u32 cur = param1;
    u32 resourceChr = WaluigiResourceCharacter(chr);
    u32 resourceCur = WaluigiResourceCharacter(cur);
    u32 base = mCharFileBase;
    u32 m1, m2;

    ((SharedFilePtr *)(data_ov002_020ff480[base + resourceCur]))->Release();
    _ZN6Player18SetNewHatCharacterEjjb(((char *)this), chr, 0, 1);
    param1 = chr;
    mCharacter = (u8)chr;
    data_02092128[mPlayerNo] = (u8)param1;
    data_0209caa0[0x41] = (u8)param1;
    _ZN9Animation8LoadFileER13SharedFilePtr(*data_ov002_020ff480[mCharFileBase + resourceChr]);
    ...
    _ZN10ModelAnim24CopyERKS_Pcj( *(void **)(((char *)this) + m1 * 4 + 0xdc), *(void **)(((char *)this) + m2 * 4 + 0xdc), *(char **)((char *)data_ov002_020ff480[mCharFileBase + resourceChr] + 4), 0);
    m1 = _ZNK6Player14GetBodyModelIDEjb(((char *)this), chr, 0);
    _ZN10ModelAnim213Func_020162C4Eji5Fix12IiEt( *(void **)(((char *)this) + m1 * 4 + 0xdc), *(int *)((char *)data_ov002_020ff480[resourceChr + 0xc4] + 4), 0, 0x1000, 0);
}
}
